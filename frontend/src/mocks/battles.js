    ...
    teams: [
      {
        ...
        color: { r: 0.117647097, g: 0.752941191, b: 0.678431392, a: 1.0 },
        players: [
          { weapon_id: 201, sub_weapon_code: 5, special_weapon_code: 11, name: 'いおりまる', k: 10, d: 6, a: 0, sp: 3, p: 812, is_myself: 0, crown: 1 },
          { weapon_id: 4020, sub_weapon_code: 7, special_weapon_code: 6, name: 'レイ', k: 5, d: 1, a: 2, sp: 3, p: 1007, is_myself: 0, crown: 0 },
          { weapon_id: 10, sub_weapon_code: 0, special_weapon_code: 2, name: 'moca', k: 4, d: 4, a: 1, sp: 3, p: 973, is_myself: 0, crown: 0 },
          { weapon_id: 40, sub_weapon_code: 1, special_weapon_code: 1, name: 'しゃけちゃずけ', k: 8, d: 7, a: 0, sp: 2, p: 908, is_myself: 0, crown: 0 }
        ]
      },
      {
        team_role: 'MY',
        ...
        color: { r: 0.847058773, g: 0.294117689, b: 0.196078405, a: 1.0 },
        players: [
          { weapon_id: 1, sub_weapon_code: 8, special_weapon_code: 9, name: 'rice', k: 9, d: 7, a: 1, sp: 3, p: 814, is_myself: 0, crown: 0 },
          { weapon_id: 41, sub_weapon_code: 0, special_weapon_code: 14, name: 'ķìľľ', k: 8, d: 7, a: 3, sp: 2, p: 1001, is_myself: 0, crown: 0 },
          { weapon_id: 7011, sub_weapon_code: 3, special_weapon_code: 16, name: 'メロンパン', k: 1, d: 2, a: 1, sp: 3, p: 953, is_myself: 0, crown: 0 },
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 7, d: 8, a: 2, sp: 3, p: 676, is_myself: 1, crown: 0 }
        ]
      }
    ]
  },
    ...
    teams: [
      {
        ...
        players: [
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 5, d: 3, a: 2, sp: 4, p: 1350, is_myself: 1, crown: 0 }
        ]
      },
      {
        team_role: 'OTHER',
    ...
    teams: [
      {
        ...
        players: [
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 12, d: 2, a: 5, sp: 4, p: 1580, is_myself: 1, crown: 1 }
        ]
      },
      {
        team_role: 'OTHER',
    ...
    teams: [
      {
        ...
        color: { r: 0.749019623, g: 0.807843089, b: 0.254902005, a: 1.0 },
        players: [
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 8, d: 5, a: 3, sp: 8, p: 1420, is_myself: 1, crown: 0 }
        ]
      },
      {
        team_role: 'OTHER',
    ...
    teams: [
      {
        ...
        players: [
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 10, d: 4, a: 2, sp: 5, p: 1600, is_myself: 1, crown: 0 }
        ]
      },
      {
        team_role: 'OTHER',
    ...
    teams: [
      {
        ...
        players: [
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 3, d: 6, a: 1, sp: 3, p: 1200, is_myself: 1, crown: 0 }
        ]
      },
      {
        team_role: 'OTHER',
    ...
    teams: [
      {
        ...
        players: [
          { weapon_id: 7030, sub_weapon_code: 7, special_weapon_code: 11, name: 'わくここね', k: 0, d: 0, a: 0, sp: 0, p: 320, is_myself: 1, crown: 0 }
        ]
      },
      {
        team_role: 'OTHER',
...
export const mockWeapons = {
  ...
  7012: { code: 7012, name: '三发猎鱼弓 灯', class: '弓', sub_code: 12, special_code: 10 },
  41: { code: 41, name: '斯普拉射击枪 联名', class: '射击枪', sub_code: 0, special_code: 14 },
  40: { code: 40, name: '斯普拉射击枪', class: '射击枪', sub_code: 1, special_code: 1 },
  31: { code: 31, name: '专业模型枪RG', class: '射击枪', sub_code: 3, special_code: 6 },
  2030: { code: 2030, name: '公升4K', class: '狙击枪', sub_code: 10, special_code: 7 },
  1: { code: 1, name: '广域标记枪 新型', class: '射击枪', sub_code: 8, special_code: 9 },
  10: { code: 10, name: '新叶射击枪', class: '射击枪', sub_code: 0, special_code: 2 },
  100: { code: 100, name: '太空射击枪', class: '射击枪', sub_code: 9, special_code: 9 },
  ...
  1042: { code: 1042, name: '宽滚筒 惑', class: '滚筒', sub_code: 13, special_code: 18 }
}
